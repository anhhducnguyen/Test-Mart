...
namespace sieu_thi_mini.Test
{
    ...
    // 
    //  [DebuggerVisualizer(typeof(Debug))]
    //  [Serializable]
    ...
    /// </summary>
    public class Debug : DialogDebuggerVisualizer
    {
        ...
        // 
        //    Debug.TestShowVisualizer(new SomeType());
        // 
        /// <summary>
        ...
        {
            VisualizerDevelopmentHost visualizerHost = new VisualizerDevelopmentHost(objectToVisualize, typeof(Debug));
