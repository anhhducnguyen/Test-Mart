...
namespace AutoTest
{
    ...
    public class SaveOrder
    {
        ...
        public void SaveOrderTest()
        {
            ...
            var orderButton = driver.FindElementById("btnSanPham");
            Assert.IsNotNull(loginButton, "Không tìm thấy nút sản phẩm.");
            orderButton.Click();
            System.Threading.Thread.Sleep(5000);



            //var OrderElement = driver.FindElementByName("Order");
            //Assert.IsNotNull(OrderElement, "Đăng nhập thất bại, không tìm thấy phần tử của màn hình chính.");

            //var product1 = driver.FindElementById("btbt");
            //product1.Click();


            // Trigger invoice creation
            var createInvoiceButton = driver.FindElementById("btSave");
